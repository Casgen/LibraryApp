...
{
    public class UserByIdDataLoader : BatchDataLoader<string, UserModel>
    {
        ...
        protected override async Task<IReadOnlyDictionary<string, UserModel>> LoadBatchAsync(IReadOnlyList<string> keys, CancellationToken cancellationToken)
        {
